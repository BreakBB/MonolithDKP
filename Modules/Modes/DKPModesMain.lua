...
function MonDKP:DKPModes_Main()
    ...
    f.DKPModesMain.AntiSnipe:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.AntiSnipe = f.DKPModesMain.AntiSnipe:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.AntiSnipe:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.AntiSnipe = f.DKPModesMain.AntiSnipe:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.AntiSnipe:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.AntiSnipe = f.DKPModesMain.AntiSnipe:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.AntiSnipe:SetScript("OnKeyUp", function(self)
        -- clears focus on esc
    ...
    if not MonDKP_DB.modes.CostSelection then
    ...
    if not MonDKP_DB.modes.Inflation then
        MonDKP_DB.modes.Inflation = 0
    end
    ...
    f.DKPModesMain.Inflation:Hide();
    f.DKPModesMain.Inflation:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.Inflation = f.DKPModesMain.Inflation:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.Inflation:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.Inflation = f.DKPModesMain.Inflation:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.Inflation:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.Inflation = f.DKPModesMain.Inflation:GetNumber()
        self:ClearFocus()
    end)
    ...
    -- Min Roll Editbox
    if not MonDKP_DB.modes.MaximumBid then
        MonDKP_DB.modes.MaximumBid = 0
    end
    ...
    f.DKPModesMain.MaxBid:Hide();
    f.DKPModesMain.MaxBid:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.MaximumBid = f.DKPModesMain.MaxBid:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.MaxBid:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.MaximumBid = f.DKPModesMain.MaxBid:GetNumber()
        self:ClearFocus()
    end)
    f.DKPModesMain.MaxBid:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.MaximumBid = f.DKPModesMain.MaxBid:GetNumber()
        self:ClearFocus()
    end)
    ...
    f.DKPModesMain.MaxBid:SetScript("OnKeyUp", function(self)
        -- clears focus on esc
    ...
    f.DKPModesMain.RollContainer.rollMin:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
    ...
    f.DKPModesMain.RollContainer.rollMin:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.rollMin:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.rollMax:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.rollMax:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.rollMax:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.AddMax:SetScript("OnEscapePressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.AddMax:SetScript("OnTabPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
    ...
    f.DKPModesMain.RollContainer.AddMax:SetScript("OnEnterPressed", function(self)
        -- clears focus on esc
        MonDKP_DB.modes.rolls.min = f.DKPModesMain.RollContainer.rollMin:GetNumber()
        MonDKP_DB.modes.rolls.max = f.DKPModesMain.RollContainer.rollMax:GetNumber()
        MonDKP_DB.modes.rolls.AddToMax = f.DKPModesMain.RollContainer.AddMax:GetNumber()
