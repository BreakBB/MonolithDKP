...
function MonDKP:AutoAward(phase, amount, reason)
    -- phase identifies who to award (1=just raid, 2=just standby, 3=both)
    local tempList = "";
    local tempList2 = "";
    local curTime = time();
    ...
    if MonDKP:CheckRaidLeader() then
        -- only allows raid leader to disseminate DKP
