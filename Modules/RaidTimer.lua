...
function MonDKP:StartRaidTimer(pause, syncTimer, syncSecondCount, syncMinuteCount, syncAward)
    ...
    MonDKP.RaidTimer:SetScript("OnUpdate", function(self, elapsed)
        ...
        if SecondCount >= 60 then
            -- counds minutes past toward interval
            SecondCount = 0;
        ...
        if MinuteCount >= increment and increment > 0 then
            -- apply bonus once increment value has been met
            MinuteCount = 0;
